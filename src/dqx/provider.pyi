...
from dqx.common import ResultKey, RetrievalFn, Tags
...
class MetricProvider(SymbolicMetricBase):
    ...
    def symbol_deduplication(self, graph: object, context_key: ResultKey) -> None: ...
    def metric(self, metric: MetricSpec, lag: int = 0, dataset: str | None = None) -> sp.Symbol: ...
