...
class VerificationSuite:
    ...
    def __init__(
        ...
        Args:
            ...
            name: Human-readable name for the suite (required).
        ...
        Raises:
            DQXError: If checks is empty, if name is missing/empty, or if config file is invalid.
        ...
        # Validation: checks must be provided
        if not checks:
        ...
        if name is _NAME_NOT_PROVIDED:  # pragma: no cover
