...
echo "  uv run hooks                # Run on staged files"
echo "  uv run hooks --all          # Run on all files"
echo "  uv run hooks --fast         # Skip slow checks (mypy)"
echo "  uv run hooks --fix          # Run only auto-fixing hooks"
echo "  uv run hooks --check-commit # Check last commit message"
echo ""
echo "Other development commands:"
echo "  uv run coverage             # Run tests with coverage"
echo "  uv run cleanup              # Clean cache files"
echo "  uv run cleanup --dry-run    # Preview what would be cleaned"
echo ""
